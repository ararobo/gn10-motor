...
#define VCC_check_Pin GPIO_PIN_6
#define VCC_check_GPIO_Port GPIOA
#define LIM2_Pin GPIO_PIN_7
#define LIM2_GPIO_Port GPIOA
#define LIM2_EXTI_IRQn EXTI9_5_IRQn
#define LIM1_Pin GPIO_PIN_10
#define LIM1_GPIO_Port GPIOA
#define LIM1_EXTI_IRQn EXTI15_10_IRQn
